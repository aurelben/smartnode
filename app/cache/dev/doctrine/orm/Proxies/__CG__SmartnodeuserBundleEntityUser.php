...
namespace Proxies\__CG__\Smartnode\userBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Smartnode\userBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'gender', 'avatar', 'borndate', 'actived', 'lastactive', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setBorndate($borndate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBorndate', array($borndate));

        return parent::setBorndate($borndate);
    }
